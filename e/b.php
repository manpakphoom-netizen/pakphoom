        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                    ...
                    <div class="card shadow-lg border-0">
                        ...
                        <div class="card-body p-4 p-md-5">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-center mt-5">
                                <button type="Submit" name="Submit" class="btn btn-success btn-lg px-5 me-md-2">ส่งใบสมัคร</button>
                ...
                if (isset($_POST['Submit'])){
                    ...
                    $sql = "INSERT INTO applications(a_id, a_position, a_prefix,a_fullname,a_dob,a_education,a_skills,a_experience) 
                    VALUES (NULL, '{$position}','{$prefix}','{$fullname}','{$dob}','{$education}','{$skills}','{$experience}');";
